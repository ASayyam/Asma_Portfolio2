          ...
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                Let's build the future together! As an agentic AI developer, I
                specialize in creating intelligent, autonomous solutions that
                enhance efficiency and innovation. Whether you're looking for
                AI-driven applications, automation tools, or cutting-edge web
                solutions, I'm here to help. Reach out, and let's turn your
                vision into reality!
              </p>
