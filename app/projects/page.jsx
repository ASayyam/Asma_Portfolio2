...
const projects = [
  {
    ...
    description:
      "A chatbot application designed to assist teachers with common queries and tasks.",
...

  {
    ...
    description:
      "A digital version of my curriculum vitae, highlighting my professional experience and skills.",
  ...
  },
  {
    ...
    description:
      "An AI-powered tutor agent designed to enhance online learning experiences.",
  ...
  },
  {
    ...
    description:
      "An AI teaching assistant equipped with a user-friendly interface to facilitate learning.",
  ...
  },
  {
    ...
    description:
      "A full-stack application to manage daily tasks, built with modern web technologies.",
  ...
  },
  {
    ...
    description:
      "A project demonstrating the use of Crewai for building intelligent agents.",
  ...
  },
  {
    ...
    description:
      "An AI agent designed to assist students in self-study, equipped with short-term memory capabilities.",
  ...
  },
  {
    ...
    description:
      "A project demonstrating the use of Crewai for building an agents that creats poems",
  ...
  },
  {
    ...
    description:
      "A Project of Online Mart using Kafka, Dev. containers and Microservices.",
