...
export default function Page() {
  return (
    <div className="min-h-screen bg-black p-10 flex flex-col items-center text-white">
      <motion.h1 
      ...
      >
        With 12+ years of experience in education, AI, and software development, I bring a unique blend of leadership and technical expertise to every project.
      </motion.p>
